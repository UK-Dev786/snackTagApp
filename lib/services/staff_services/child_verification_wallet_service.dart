...
class ChildVerificationWalletService extends BaseService {
  ...
  Future<bool> saveOrderPreparation(ParentsAddChildren childData,
      String staffName, String cafeteriaId, meal) async {
    try {
      ...
      Map<String, dynamic> orderPrepData = {
        ...
        'selectedMealMenuData': meal is ParentSelectedMeals
            ? [meal.toMap()]
            : [
                ParentSelectedMeals.fromMap(meal as Map<String, dynamic>)
                    .toMap()
              ],
  ...
  Future<bool> isOrderAlreadyPreparedToday(String childId, meal) async {
    try {
