...
class ChildVerificationUploadInfoView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: GetBuilder<ChildVerificationUploadInfoController>(
                                ...
                                return Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Obx(() {
                                        final status =
                                            controller.getMealStatus(meal);

                                        // Default to an empty container (hidden button)
                                        Widget buttonWidget =
                                            const SizedBox.shrink();

                                        // Only show button if not delivered or in preparation
                                        if (status != 'Delivered' &&
                                          ...
                                          // Show status indicator instead of button
