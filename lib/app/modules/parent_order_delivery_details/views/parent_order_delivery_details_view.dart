...
class ParentOrderDeliveryDetailsView extends StatelessWidget {
  const ParentOrderDeliveryDetailsView({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: GetBuilder<ParentOrderDeliveryDetailsController>(
            init: ParentOrderDeliveryDetailsController(),
            id: parentOrderDeliveryDetailsId,
            builder: (controller) {
              return Obx(() {
