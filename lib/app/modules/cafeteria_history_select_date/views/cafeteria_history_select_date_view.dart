                ...
                TableCalendar(
                  ...
                  calendarBuilders: CalendarBuilders(
                    ...
                    todayBuilder: (context, day, focusedDay) {
                      ...
                      bool isSelected = cafateriaHSDCont.isDateSelected.value &&
                          cafateriaHSDCont.isSameDay(
                              day, cafateriaHSDCont.selectedDate.value);

                      // If today is selected or another date is selected, use the selected style
                      if (cafateriaHSDCont.isDateSelected.value) {
                        ...
                        if (isSelected) {
                          ...
                          String hasMealToday =
                              cafateriaHSDCont.checkIfDateHasMeal(day);
                          return Center(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                ...
                Expanded(
                  child: Obx(() {
                    ...
                    return ListView.builder(
                      itemCount: cafateriaHSDCont.upComingMealOrderList.length,
                      padding: const EdgeInsets.only(top: 0),
                      itemBuilder: (context, index) {
                        return _buildOrderCard(context, cafateriaHSDCont,
                            cafateriaHSDCont.upComingMealOrderList[index]);
                      },
                    );
                  }),
                ),
